      ...
      <div class="w3-col m6">
        <form  action="post_info.php" method="POST" enctype="multipart/form-data">
          <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
            <div class="w3-half">
              <input class="w3-input w3-border" type="text" placeholder="Email" name="Email" value="Email">
            </div>
            <div class="w3-half">
              <input class="w3-input w3-border" type="text" placeholder="Name" name="Name" value="Name">
            </div>
            <div class="w3-half">
              <input class="w3-input w3-border" type="text" placeholder="Message" name="Message" value="Message">
            </div>  
            <div class="w3-half">
              <input class="w3-input w3-border" type="file" accept="image/png, image/jpg" name="Picture_profile">
            </div> 
